<component name="InspectionProjectProfileManager">
  <profile version="1.0" is_locked="false">
    ...
    <inspection_tool class="CssInvalidAtRule" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidCharsetRule" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidElement" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidFunction" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidHtmlTagReference" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidImport" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidMediaFeature" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidPropertyValue" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssInvalidPseudoSelector" enabled="false" level="TYPO" enabled_by_default="false" />
    <inspection_tool class="CssNegativeValue" enabled="false" level="TYPO" enabled_by_default="false" />
    ...
    <inspection_tool class="CssUnknownProperty" enabled="false" level="TYPO" enabled_by_default="false">
    ...
    <inspection_tool class="CssUnknownTarget" enabled="false" level="TYPO" enabled_by_default="false" />
    ...
    <inspection_tool class="GitignoreCoverEntry" enabled="false" level="WARNING" enabled_by_default="false" />
    <inspection_tool class="GitignoreDuplicateEntry" enabled="false" level="ERROR" enabled_by_default="false" />
    <inspection_tool class="GitignoreUnusedEntry" enabled="false" level="GITIGNORE.UNUSED_ENTRY" enabled_by_default="false" />
